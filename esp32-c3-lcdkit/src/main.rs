...
use hal::{
    ...
    prelude::*,
    riscv,
    spi::{master::prelude::_esp_hal_spi_master_dma_WithDmaSpi2, master::Spi, SpiMode},
    timer::{Timer, Timer0, TimerGroup},
    Delay, Rng, IO,
};

use spooky_embedded::embedded_display::{LCD_H_RES, LCD_MEMORY_SIZE, LCD_PIXELS, LCD_V_RES};
...
fn main() -> ! {
    ...
    let rotary_movement_controller =
        crate::rotary_movement_controller::RotaryMovementController::new();
    let movement_controller = crate::lcdkit_composite_controller::LcdKitCompositeController::new(
        demo_movement_controller,
        rotary_movement_controller,
    );
