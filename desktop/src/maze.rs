...
pub struct Maze {
    ...
    // For simplicity, we use a homogeneous array.
    // You can adjust this to either a dynamic or static maze data
    // depending on your feature flags.
    pub data: [u8; 64 * 64],
    pub coins: [Coin; 100],
...
impl Maze {
    ...
    pub fn new(width: u32, height: u32, seed: Option<[u8; 32]>) -> Self {
        Self {
            ...
            data: {
                // For brevity, we simply fill the static maze with 1’s.
                // Replace this with your actual static maze data if needed.
                [1; 64 * 64]
            },
            offset: width + 1,
            tile_width: 16,
