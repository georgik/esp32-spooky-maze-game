...
use esp_bsp::boards::esp32s3box::{lcd_dma_spi, lcd_display_interface, lcd_reset_pin, lcd_backlight_init,
...
fn main() -> ! {
    ...
    let mut display = lcd_display!(peripherals, di, orientation)
        .init(&mut delay)
        .unwrap();
