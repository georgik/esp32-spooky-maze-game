    ...
    DISP: DrawTarget<Color = Rgb565>,
{
    ...
    let no_movement_controller = spooky_core::nomovement_controller::NoMovementController::new();
    ...
    let mut universe = Universe::new_with_movement_controller(engine, no_movement_controller);
